...
-(void) initView
{
    ...
    {
        FirstView.contentSize = CGSizeMake(bounds.size.width, bounds.size.height-45+145);
        rect = CGRectMake(0, 138*3, bounds.size.width, 145);
    ...
    rect = CGRectMake(bounds.size.width, 0, bounds.size.width, 45);
    imageView.frame =rect;
    [self addSubview:imageView];
    [imageView release];
...
//    [self addSubview:SecondView];
    ...
    if(bookTableView == nil)
    {
        ...
        bookTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 45, bounds.size.width, bounds.size.height-45)];
